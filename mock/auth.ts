...
const bossMenus = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'BossCashier',
        path: '/boss/cashier',
        component: 'views/boss/cashier/index',
        redirect: '',
        icon: 'CreditCard',
        title: '收银',
        hidden: false,
      ...
      },
      {
        ...
        name: 'BossStores',
        path: '/boss/stores',
        component: 'views/boss/stores/index',
        redirect: '',
        icon: 'Shop',
        title: '门店管理',
        hidden: false,
      ...
      },
      {
        ...
        name: 'BossReports',
        path: '/boss/reports',
        component: 'views/boss/reports/index',
        redirect: '',
        icon: 'TrendCharts',
        title: '经营报表',
        hidden: false,
