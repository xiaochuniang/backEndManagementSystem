  ...
  },
  {
    ...
    userInfo: {
      ...
      permissions: [
        ...
        'customerOps:coupon:view',
        'customerOps:about:view',
      ],
    },
  },
]
...
const staffMenus = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'StaffShift',
        path: '/staff/shift',
        component: 'views/staff/shift/index',
        redirect: '',
        icon: 'DocumentChecked',
        title: '交班对账',
        hidden: false,
...
const customerOpsMenus = [
  {
    ...
    children: [
      ...
      },
      {
        id: 35,
        parentId: 3,
        name: 'CustomerOpsCoupons',
        path: '/customer-ops/coupons',
        component: 'views/customer-ops/coupons/index',
        redirect: '',
        icon: 'Ticket',
        title: '优惠券',
        hidden: false,
        keepAlive: false,
        type: 1,
        permission: 'customerOps:coupon:view',
        sort: 5,
        children: [],
      },
      {
        id: 36,
        parentId: 3,
        name: 'CustomerOpsAbout',
        path: '/customer-ops/about',
        component: 'views/customer-ops/about/index',
        redirect: '',
        icon: 'InfoFilled',
        title: '关于我们',
        hidden: false,
        keepAlive: true,
        type: 1,
        permission: 'customerOps:about:view',
        sort: 6,
        children: [],
      },
    ],
